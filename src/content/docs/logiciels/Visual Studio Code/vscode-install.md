...
![alt text](./images/vscode-install-1766068749687.png)

Le téléchargement se lance automatiquement.

Exécutez le fichier VSCodeUserSetup-x64-…….exe.

![alt text](./images/vscode-install-1766068775158.png)

On accepte la licence
Visual Studio Code s’installe dans votre répertoire personnel, laissez l’emplacement par défaut :

![alt text](./images/vscode-install-1766068786553.png)

Valider ensuite les étapes suivantes.

![alt text](./images/vscode-install-1766068796210.png)
![alt text](./images/vscode-install-1766068807880.png)
![alt text](./images/vscode-install-1766068819752.png)
![alt text](./images/vscode-install-1766068834184.png)

Une fois l’installation terminée, vous pouvez lancer le programme.

![alt text](./images/vscode-install-1766068841668.png)

On arrive sur l’interface de VS Code.

![alt text](./images/vscode-install-1766068851354.png)
